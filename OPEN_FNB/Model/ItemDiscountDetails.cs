            ...
            try
            {
                ...
                while (rs.Read())
                {
                    ...
                    list.Add(new ItemDiscountDetails(
                        ...
                        ,new Item(rs.GetInt32(0+n), rs.GetString(1 + n), rs.GetInt32(2 + n), new Bitmap(1, 1), rs.GetBoolean(4 + n), rs.GetBoolean(5 + n), rs.GetInt16(6 + n), rs.GetString(7 + n), rs.GetString(8 + n))
